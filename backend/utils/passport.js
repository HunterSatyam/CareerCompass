...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    ...
    const googleCallback = `${BASE_URL}/api/v1/user/auth/google/callback`;
    console.log(`[AUTH] Google Callback: ${googleCallback}`);
    passport.use(
        "google",
        new GoogleStrategy(
            {
            ...
            async (accessToken, refreshToken, profile, done) => {
                try {
                    ...
                    if (!user) {
                        ...
                        sendWelcomeEmail(profile.displayName, profile.emails[0].value);
            ...
            async (accessToken, refreshToken, profile, done) => {
                try {
                    ...
                    if (!user) {
                        ...
                        sendWelcomeEmail(profile.displayName || profile.username, email);
        ...
        new LinkedInStrategy(
            {
                ...
                callbackURL: `${BASE_URL}/api/v1/user/auth/linkedin/callback`,
            ...
            async (accessToken, refreshToken, profile, done) => {
                try {
                    ...
                    if (!user) {
                        ...
                        sendWelcomeEmail(profile.displayName, email);
